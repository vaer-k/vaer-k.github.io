...
// 
const SHELL_CACHE = "shell-8.0.0-beta.8--v1--sw/";
...
const CONTENT_CACHE = "content--2018-07-11T13:07:29-07:00--sw/";
...
const SHELL_FILES = [
  ...
  "/assets/js/hydejack-8.0.0-beta.8.js",
  "/assets/css/hydejack-8.0.0-beta.8.css",
...
const ASSET_FILES = [
  /**/ "/assets/img/Stop_the_light_by_Mato_Rachela_blur.png" /**/,
...
function isSameSite({ origin, pathname }) {
  return origin.startsWith("https://vaer-k.net") && pathname.startsWith("");
}
